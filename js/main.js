...
function getNewCard() {
  ...
  const tempIcon = createElement('svg', 'card-param__icon')
  tempIcon.innerHTML = `
    <path
  ...
  cardHeadRight.append(tempIcon, tempText);
  ...
  // информация о ветре
  const windIcon = createElement('svg', 'card-param__icon card-param-icon_footer');
  windIcon.innerHTML = `
    <path
  ...
  const humidityIcon = createElement('svg', 'card-param__icon card-param-icon_footer');
  ...
  footerLeft.append(windIcon, windText);
  footerRight.append(humidityIcon, humidityText);
